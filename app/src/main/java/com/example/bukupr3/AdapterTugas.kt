...
class AdapterTugas () : RecyclerView.Adapter <AdapterTugas.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return AdapterTugas.ViewHolder(view)
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.tvItemNamaBukuPr.text = tugas[position].namaTugas

        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, DetailTugasActivity::class.java)
            intent.putExtra("tugas", tugas[position])
